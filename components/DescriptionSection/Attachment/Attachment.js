...
const Attachment = () => (
  <StyledAttachment>
    <FeaturedItem heading="think deeply">
      ...
      accurately - only then will you see the effects of your hard work. In today&apos;s world taken over by computers
      and social media, it is hard for us people to focus on taking responsibility for our lives. We like to complain
      and blame everything else, but not ourselves for our fate. TDE is a way of thinking that will allow us to see and
